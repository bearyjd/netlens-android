...
-keep,includedescriptorclasses class com.ventouxlabs.netlens.**$$serializer { *; }
-keepclasseswithmembers class com.ventouxlabs.netlens.** { kotlinx.serialization.KSerializer serializer(...); }
...
-keep class com.ventouxlabs.netlens.billing.** { *; }
