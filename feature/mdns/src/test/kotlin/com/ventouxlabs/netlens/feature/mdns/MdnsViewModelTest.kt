...
import com.ventouxlabs.netlens.feature.mdns.engine.FakeMdnsScanner
import com.ventouxlabs.netlens.feature.mdns.model.MdnsService
import com.ventouxlabs.netlens.feature.mdns.model.MdnsUiState
...
class MdnsViewModelTest {
    ...
    fun `scan with flow error shows error in state`() = runTest {
        ...
        val errorScanner = object : com.ventouxlabs.netlens.feature.mdns.engine.MdnsScanner {
