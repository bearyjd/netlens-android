...
@Composable
private fun PingDetail(entry: com.ventouxlabs.netlens.core.data.model.PingHistoryEntry) {
...
@Composable
private fun LanScanDetail(entry: com.ventouxlabs.netlens.core.data.model.LanScanHistoryEntry) {
    Column(verticalArrangement = Arrangement.spacedBy(4.dp)) {
...
@Composable
private fun PortScanDetail(entry: com.ventouxlabs.netlens.core.data.model.PortScanHistoryEntry) {
    Column(verticalArrangement = Arrangement.spacedBy(4.dp)) {
        DetailRow("Host", entry.host)
...
@Composable
private fun DnsDetail(entry: com.ventouxlabs.netlens.core.data.model.DnsHistoryEntry) {
    Column(verticalArrangement = Arrangement.spacedBy(4.dp)) {
...
@Composable
private fun WhoisDetail(entry: com.ventouxlabs.netlens.core.data.model.WhoisHistoryEntry) {
    Column(verticalArrangement = Arrangement.spacedBy(4.dp)) {
        DetailRow("Query", entry.query)
        Spacer(Modifier.height(4.dp))
        Text(
...
@Composable
private fun IpInfoDetail(entry: com.ventouxlabs.netlens.core.data.model.IpInfoHistoryEntry) {
    Column(verticalArrangement = Arrangement.spacedBy(4.dp)) {
...
@Composable
private fun TracerouteDetail(entry: com.ventouxlabs.netlens.core.data.model.TracerouteHistoryEntry) {
    Column(verticalArrangement = Arrangement.spacedBy(4.dp)) {
        DetailRow("Host", entry.host)
...
@Composable
private fun TlsDetail(entry: com.ventouxlabs.netlens.core.data.model.TlsHistoryEntry) {
    Column(verticalArrangement = Arrangement.spacedBy(4.dp)) {
...
@Composable
private fun HttpTestDetail(entry: com.ventouxlabs.netlens.core.data.model.HttpTesterHistoryEntry) {
    Column(verticalArrangement = Arrangement.spacedBy(4.dp)) {
...
@Composable
private fun MdnsDetail(entry: com.ventouxlabs.netlens.core.data.model.MdnsHistoryEntry) {
    Column(verticalArrangement = Arrangement.spacedBy(4.dp)) {
...
@Composable
private fun WolDetail(entry: com.ventouxlabs.netlens.core.data.model.WolHistoryEntry) {
    Column(verticalArrangement = Arrangement.spacedBy(4.dp)) {
