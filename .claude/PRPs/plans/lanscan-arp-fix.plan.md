...
- **ACTION**: Create new file `feature/lanscan/src/main/kotlin/us/beary/netlens/feature/lanscan/model/DiscoveryMethod.kt`
- **IMPLEMENT**:
  ```kotlin
...
- **IMPORTS**: `us.beary.netlens.feature.lanscan.model.DiscoveryMethod`
...
- **IMPORTS**: Add `kotlinx.coroutines.sync.Semaphore`, `kotlinx.coroutines.sync.withPermit`, `kotlinx.coroutines.withTimeoutOrNull`; remove `us.beary.netlens.core.oui.OuiLookup`
...
- **ACTION**: Delete `feature/lanscan/src/main/kotlin/us/beary/netlens/feature/lanscan/engine/ArpTableReader.kt`
- **IMPLEMENT**: `git rm feature/lanscan/src/main/kotlin/us/beary/netlens/feature/lanscan/engine/ArpTableReader.kt`
- **MIRROR**: N/A
- **IMPORTS**: N/A
...
- **ACTION**: Create `feature/lanscan/src/test/kotlin/us/beary/netlens/feature/lanscan/engine/SubnetScannerImplTest.kt`
- **IMPLEMENT**:
  ```kotlin
