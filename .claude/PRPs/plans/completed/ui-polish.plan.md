...
|---|---|---|---|
| P0 | `app/src/main/kotlin/com.ventouxlabs.netlens/ui/theme/Theme.kt` | all | Current theme setup |
| P0 | `app/src/main/kotlin/com.ventouxlabs.netlens/ui/theme/Color.kt` | all | Current color palette |
| P1 | `feature/ipinfo/src/main/kotlin/com.ventouxlabs.netlens/feature/ipinfo/IpInfoScreen.kt` | 96-119 | Loading/error/success pattern |
| P1 | `feature/lanscan/src/main/kotlin/com.ventouxlabs.netlens/feature/lanscan/LanScanScreen.kt` | 150-200 | List with empty state gap |
| P2 | `feature/ping/src/main/kotlin/com.ventouxlabs.netlens/feature/ping/PingScreen.kt` | all | Screen without explicit empty state |
...
### THEME_SETUP
// SOURCE: app/src/main/kotlin/com.ventouxlabs.netlens/ui/theme/Theme.kt:24-38
```kotlin
@Composable
fun NetLensTheme(
...
### ERROR_STATE
// SOURCE: feature/ipinfo/src/main/kotlin/com.ventouxlabs.netlens/feature/ipinfo/IpInfoScreen.kt:121-149
```kotlin
@Composable
